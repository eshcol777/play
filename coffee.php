...
$sql = "select coffee_income,coffee_expense,coffee_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date limit 7 ";
$get = "select coffee_income,coffee_expense,coffee_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(income.date) = DATE(NOW()) ";
$bu= "select coffee_income,coffee_expense,coffee_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(expense.date) = DATE(NOW()) ";
$bi= "select coffee_income,coffee_expense,coffee_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(profit.date) = DATE(NOW()) ";
        ...
        <div id="content">
            <div class="top-navbar">
                ...
                <span class="material-icons">arrow_back_ios</span>
                        ...
                        <a class="navbar-brand text-light" href="#"> coffee&tea</a>
                            ...
                            <div class="card-content">
                                ...
                                <?php
                                     while($row=mysqli_fetch_assoc($res))
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['coffee_income']?></h3>
                                 <?php
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                ...
                                <?php
                                           ...
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['coffee_expense']?></h3>
                                 <?php
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                ...
                                <?php
                                           ...
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['coffee_profit']?></h3>
                                 <?php
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['coffee_income']?></td>
                                            <td><?php echo $row['coffee_expense']?></td>
                                            <td><?php echo $row['coffee_profit']?></td>
                                        </tr>
