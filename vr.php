...
$sql = "select vr_income, vr_expense, vr_profit, income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date limit 7 ";

$get = "select vr_income, vr_expense,  vr_profit, income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(income.date) = DATE(NOW()) ";
$bu= "select vr_income, vr_expense, vr_profit, income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(expense.date) = DATE(NOW()) ";
$bi= "select vr_income, vr_expense, vr_profit, income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(profit.date) = DATE(NOW()) ";
        ...
        <div id="content">
            <div class="top-navbar">
                ...
                <span class="material-icons">arrow_back_ios</span>
                        ...
                        <a class="navbar-brand text-light" href="#"> VR</a>
                            ...
                            <div class="card-content">
                                ...
                                <?php
                                     while($row=mysqli_fetch_assoc($res))
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['vr_income']?></h3>
                                 <?php
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                ...
                                <?php
                                           ...
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['vr_expense']?></h3>
                                 <?php
                        ...
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                ...
                                <?php
                                           ...
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['vr_profit']?></h3>
                                 <?php
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['vr_income']?></td>
                                            <td><?php echo $row['vr_expense']?></td>
                                            <td><?php echo $row['vr_profit']?></td>
                                        </tr>
