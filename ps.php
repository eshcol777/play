...
$sql = "select playstation_income,playstation_expense,playstation_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date 
       limit 7 ";
$get = "select playstation_income,playstation_expense,playstation_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(income.date) = DATE(NOW()) ";
$bu= "select playstation_income,playstation_expense,playstation_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(expense.date) = DATE(NOW()) ";
$bi= "select playstation_income,playstation_expense,playstation_profit,income.date FROM income INNER JOIN expense ON income.date=expense.date INNER JOIN profit ON income.date=profit.date  WHERE DATE(profit.date) = DATE(NOW()) ";
        ...
        <div id="content">
            <div class="top-navbar">
                ...
                <span class="material-icons">arrow_back_ios</span>
                        ...
                        <a class="navbar-brand text-light" href="#"> PS</a>
                        ...
                        <div class="card card-stats">
                            ...
                            <p class="category text-info"><strong>Income</strong></p>
                                 ...
                                 <?php
                                           ...
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['playstation_income']?></h3>
                                 <?php
                            ...
                            <div class="card-content">
                                ...
                                <p class="category text-info"><strong>Expense</strong></p>
                                 <?php
                                           ...
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['playstation_expense']?></h3>
                                <?php
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <?php
                                           ...
                                           {
                                        ?>
                                <h3 class="card-title text-success"><?php echo $row['playstation_profit']?></h3>
                                 <?php
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['playstation_income']?></td>
                                            <td><?php echo $row['playstation_expense']?></td>
                                            <td><?php echo $row['playstation_profit']?></td>
                                        </tr>
